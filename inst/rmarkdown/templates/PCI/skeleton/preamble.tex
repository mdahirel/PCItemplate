...
\newcommand{\writeDOI}{doi={https://doi.org/\preprintDOI},}

\filecontentsspecials|[]
\begin{filecontents*}[overwrite]{recommendedpreprint.bib}
@article{recommendedpreprint,
  ...
  year={\pubyear},
  |writeDOI% doi = {\preprintDOI},
  %https://doi.org/xxxxxxxxxxx
}
\end{filecontents*}

\addbibresource{recommendedpreprint.bib}
...
\lhead{\ifnum\thepage=1 \includegraphics[width=13.5cm]{logo_pour_PDF_\whichPCI.png} \else \includegraphics[width=5cm]{small_logo_pour_PDF_\whichPCI.png} \fi}
...
\ifnum\pdfstrcmp{\whichPCI}{paleo}=0
  \newcommand{\PCI}{Peer Community In Palaeontology} \else %
...
%\printbibliography[type= article, env = recommendedpreprint.bib]
%@recommendedpreprint (\pubyear). \preprinttitle. \emph{\preprintserver} \space \preprintnumber, ver. \preprintversion \space peer-reviewed and recommended by \emph{\PCI}. DOI: \DOI \\
