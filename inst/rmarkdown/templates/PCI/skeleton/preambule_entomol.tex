...
\lhead{\ifnum\thepage=1 \includegraphics[width=13.5cm]{logo_pour_PDF_entomol.png} \else \includegraphics[width=5cm]{small_logo_pour_PDF_entomol.png} \fi}  
...
\newcommand{\PCI}{Peer Community In Entomology}
